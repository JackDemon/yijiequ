...
(function () {
    ...
    $(function () {
        $.ajax({
            url: 'http://nbptznjj.iego.cn/mybatisForSpring3/QueryArticleController.do',
            type: 'POST',
            dataType: 'json',
            ...
            success: function (data) {
                ...
                /*获取查询文章的data*/
                $.ajax({
                    url: 'http://nbptznjj.iego.cn/mybatisForSpring3/QueryArticleDetialController.do',
                    type: 'POST',
                    dataType: 'json',
                    contentType: "application/json",
                    success: function (data) {
        ...
        function createItem(obj) {
            ...
            NewsLeft.append($('<a href="#"></a>').html("<img src=" + obj.picurl + ">")).appendTo(NewsItem);
            ...
            NewsRight.html('<div class="NewsDate">' + obj.time + '</div>' + /*时间*/
                ...
                '<a href="#">详情信息</a></div>').appendTo(NewsItem);
            /*详细内容*/
