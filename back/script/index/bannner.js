...
(function () {
    //制造每个轮播图的块
    var bannerNumber = 5, bannerImageAllUrl = [],mainCurrentIndex = 0,preIndex = 0,opacityChangeSpeed = 0.05
    ...
    function init() {
        requestData("http://nbptznjj.iego.cn/mybatisForSpring3/QueryHomePageController.do", function (data) {
            for (var i = 0; i < bannerNumber; i++) {
