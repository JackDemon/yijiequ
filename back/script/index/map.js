$(function () {
    ...
    function request(stract) {
        ...
        var url = "http://nbptznjj.iego.cn/mybatisForSpring3/QueryAreaDetialController.do";
    ...
    window.onload=function () {
        $.ajax(
            {   url: "http://nbptznjj.iego.cn/mybatisForSpring3/QueryAreaDetialController.do",
                type:"POST",
                dataType:"json",
                timeout:5000,
